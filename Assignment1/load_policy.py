...
def load_policy(filename):
    ...
    def build_policy(obs_bo):
        ...
        for layer_name in sorted(layer_params.keys()):
            ...
            W, b = read_layer(l) # so the parameters are already trained!
            curr_activations_bd = apply_nonlin(tf.matmul(curr_activations_bd, W) + b) # get each layer output
    ...
    # apply prediction for given observation
