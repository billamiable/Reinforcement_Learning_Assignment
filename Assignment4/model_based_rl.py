...
class ModelBasedRL(object):
    ...
    def run_q1(self):
        ...
        implementation details:
            ...
            # VIP because if using each state, then become a one shot prediction problem
    ...
    def run_q2(self):
        ...
        # VIP: here the dataset is evaluate to get reward
    ...
    def run_q3(self):
        ...
        for itr in range(self._num_onpolicy_iters + 1):
            ...
            # raise NotImplementedError
            new_dataset = self._gather_rollouts(self._policy, self._num_init_random_rollouts)
